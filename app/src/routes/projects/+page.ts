  ...
  const projects: Project[] = [
    {
      ...
      github: "https://github.com/yourusername/parallel-knn",
      image: parallel,
    },
    {
      title: "OpenCV Gesture Recognition",
      description: "Real-time hand gesture recognition system using deep learning with 97% accuracy, featuring Mediapipe and OpenCV pipelines.",
      technologies: ["Python", "TensorFlow/Keras", "OpenCV", "Mediapipe"],
      github: "https://github.com/yourusername/gesture-recognition",
      image: hand,
    },
    {
      ...
      github: "https://github.com/yourusername/kaggle-insurance",
      image: kagg,
    },
    {
    ...
    },
    {
      ...
      technologies: ["Svelte", "TypeScript", "HTML/CSS", "Git"],
